...
public class RespVO<T> implements Serializable {
    ...
    /***
     * The method is planned to be removed at a later stage
     **/
    public static RespVO createSuccessResponse() {
        return new RespVO<>(RespCode.Success.getCode(), RespCode.Success.getDesc());
    }

    /***
     * The method is planned to be removed at a later stage
     **/
    public static <T> RespVO<T> createSuccessResponse(T data) {
        return new RespVO<>(RespCode.Success.getCode(), RespCode.Success.getDesc(), data);
    }
